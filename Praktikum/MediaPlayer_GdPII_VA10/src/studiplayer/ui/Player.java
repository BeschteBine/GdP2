...
public class Player extends JFrame implements ActionListener {
	...
	private String nocurrentSong = "no current song";

	private String prefix = "Current song:";

	private JLabel songDescription = new JLabel(nocurrentSong);
	private JLabel playTime = new JLabel(DEFAULT_TIME);
	...
	public void updateSongInfo(AudioFile af) {
		if (af == null) {
			...
			songDescription.setText(DEFAULT_TITLE);
			playTime.setText(DEFAULT_TIME);
